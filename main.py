...
REQUIRED_CHANNELS = ["@Tahirbpa"]
GROUP_JOIN_LINK = "https://t.me/Tahirbpa"
OWNER_ID = 6721034791
OWNER_USERNAME = "@anwpi7"
...
def call_api(region, uid):
    url = f"8635792747:AAGB-Czb5Bw4ZOhV4FXq0N9Vpnrv-ZYVwSk?uid={uid}&server_name={region}"
    try:
